...
namespace QuanLyNhanSuWEB.Controllers
{
    ...
    public class HoSoLienQuanController : Controller
    {
        private readonly HttpClient _http;
        private readonly UploadFileHelper _uploadHelper;
        private readonly IWebHostEnvironment _webHostEnvironment;

        public HoSoLienQuanController(HttpClient http, UploadFileHelper uploadHelper, IWebHostEnvironment webHostEnvironment)
        {
            _http = http;
        ...
        public async Task<ActionResult<ServiceResponse<HoSoDTO>>> Index(int nhanvienId)
        {
            ...
            var hoso = await _http.GetFromJsonAsync<ServiceResponse<List<TbHoSo>>>($"http://10.0.0.4:5259/api/HoSo/hosolienquan/{nhanvienId}");
