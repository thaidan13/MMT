...
namespace QuanLyNhanSuWEB.Controllers
{
    ...
    public class KhenThuongController : Controller
    {
        ...
        public KhenThuongController(HttpClient http, UploadFileHelper uploadHelper, IWebHostEnvironment webHostEnvironment)
        {
            _http = http;
        ...
        public async Task<ActionResult<ServiceResponse<KhenThuongKyLuatDTO>>> Index(int nhanvienId)
        {
            ...
            var khenthuong = await _http.GetFromJsonAsync<ServiceResponse<List<TbKhenThuongKyLuat>>>($"http://10.0.0.4:5259/api/KhenThuongKyLuat/khenthuong/{nhanvienId}");
